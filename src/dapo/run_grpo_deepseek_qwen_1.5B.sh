...
train_prompt_bsz=64  # total batch size
...
python3 -m src.dapo.main_dapo \
    ...
    custom_reward_function.path="src/dapo/config/plugin.py" \
    custom_reward_function.name="compute_score_all" \
